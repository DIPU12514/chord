...
plotweb(sortweb(mothweb,sort.order="inc", sequence = seq.higher), text.rot=90, method="normal", 
         arrow="down center ",col.low=c("orange","green","blue","brown","navy blue","pink","yellow","black", "sky blue","red","grey" ),col.high=c("black"),
        text.high.col=c(rep("blue",26)), col.interaction=c("brown"),
